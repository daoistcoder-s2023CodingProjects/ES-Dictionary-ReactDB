    ...
    return (
        <div className={showContainer ? "container2" : "container"}>
            <Sidebar
                ...
                showSideUser={showSideUser}
                showSideMenuList={showSideMenuList}
                showTitle={showTitle}
                showSideFooter={showSideFooter}
                showSlideSidebar={showSlideSidebar}
            />
            <main
                className={showMain ? "main-container2" : "main-container"}
                id={showSlideMain ? "slidemain2" : "slidemain"}
            >
